                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-10">
                            ...
                            <div class="mb-4">
                                ...
                                <p style="color: white;">Fill the void by shopping some of our best-selling products!
                                </p>
                            </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-2 col-lg-2 col-xl-2">
                                <img src="{{$product->products->imageLocation}}" class="img-fluid rounded-3"
                                    alt="Game - img">
                            </div>
                            <!-- Name of Product-->
                ...
                <div class="card rounded-3 mb-4">
                    <div class="card-body p-4">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                <a href="{{ url('/removefrombasket/'.$product->id) }}" class="reg-btn"
                                    style="text-decoration: none; font-size:12px; padding: 10px;">Remove</a>
