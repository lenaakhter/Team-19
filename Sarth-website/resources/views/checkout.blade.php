    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-10">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h3 class="fw-normal mb-0 text-white">Thanks for shopping with us {{Auth::user()->name}}, your Game Keys have been sent to {{Auth::user()->email}}
            ...
            <div class="row d-flex justify-content-between align-items-center">
             <!-- Image of Product-->  
              <div class="col-md-2 col-lg-2 col-xl-2">
                <img src="{{$product->productinfo->imageLocation}}"
              ...
              <div class="col-md-3 col-lg-2 ">
               ...
               <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                <h5 class="mb-0">Order Status: <strong>{{$order->status}}</strong></h5>
              </div>
